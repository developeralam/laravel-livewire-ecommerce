                         ...
                         <div class="sg-img">
                             ...
                             <div class="nav d-flex justify-content-between">
                                 <a class="nav-item nav-link active" data-toggle="tab" href="#sg1"><img
                                         src="{{ asset('frontend/images/tab-1.png') }}" alt=""></a>
                                 <a class="nav-item nav-link" data-toggle="tab" href="#sg2"><img
                                         src="{{ asset('frontend/images/tab-2.png') }}" alt=""></a>
                                 <a class="nav-item nav-link" data-toggle="tab" href="#sg3"><img
                                         src="{{ asset('frontend/images/tab-3.png') }}" alt=""></a>
                                 <a class="nav-item nav-link" data-toggle="tab" href="#sg4"><img
                                         src="{{ asset('frontend/images/tab-4.png') }}" alt=""></a>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-7">
                         <div class="sg-content">
                             ...
                             <div class="pro-price">
                                 <ul class="list-unstyled list-inline">
                                     <li class="list-inline-item">${{ $product->sale_price }}</li>
                                     <li class="list-inline-item">${{ $product->regular_price }}</li>
                                 </ul>
                                 <p>Availability : <span>{{ $product->stock_status }}</span></p>
                             </div>
                             <div class="colo-siz">
                                 <div class="color">
                                     <ul class="list-unstyled list-inline">
                                 ...
                                 <div class="pro-btns">
                                     ...
                                     <a href="#" class="fav-com" data-toggle="tooltip" data-placement="top"
                                         title="Wishlist"><img src="{{ asset('frontend/images/it-fav.png') }}"
                                             alt=""></a>
                                     <a href="#" class="fav-com" data-toggle="tooltip" data-placement="top"
                                         title="Compare"><img src="{{ asset('frontend/images/it-comp.png') }}"
                                             alt=""></a>
                                 </div>
                             </div>
                         </div>
                                     ...
                                     <div class="review-box d-flex">
                                         ...
                                         <div class="rv-content">
                                             ...
                                             <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos a
                                                 deleniti dolorem architecto quae eligendi voluptatem omnis beatae at
                                                 aut eveniet repellendus voluptas.</p>
                                         </div>
                                     </div>
                                     <div class="review-box d-flex">
                                         <div class="rv-img">
                                     ...
                                     <div class="sim-item">
                                         <div class="sim-img">
                                             <img class="main-img img-fluid"
                                                 src="{{ asset('images/product/' . $related->image) }}"
                                                 alt="{{ $related->name }}">
                                             <div class="layer-box">
                                         ...
                                         <div class="img-content d-flex justify-content-between">
                                             <div>
                                                 ...
                                                 <ul class="list-unstyled list-inline price">
                                                     <li class="list-inline-item">${{ $related->sale_price }}</li>
                                                     <li class="list-inline-item">${{ $related->regular_price }}</li>
                                                 </ul>
                                             </div>
                                             <div>
             ...
             <div class="col-md-3">
                 ...
                 <div class="ht-offer">
                     ...
                     <div class="ht-body owl-carousel">
                         <div class="ht-item">
                             <div class="ht-img">
                                 <a href="#"><img src="{{ asset('frontend/images/tab-15.png') }}" alt=""
                                         class="img-fluid"></a>
                                 <span>- 59%</span>
                         ...
                         <div class="ht-item">
                             <div class="ht-img">
                                 <a href="#"><img src="{{ asset('frontend/images/tab-14.png') }}" alt=""
                                         class="img-fluid"></a>
                                 <span>- 59%</span>
                                 <ul class="list-unstyled list-inline counter-box">
                                     <li class="list-inline-item">185 <p>Days</p>
                 ...
                 <div class="add-box">
                     <a href="#"><img src="{{ asset('frontend/images/s-banner1.jpg') }}" alt=""
                             class="img-fluid"></a>
                 </div>
             </div>
         </div>
